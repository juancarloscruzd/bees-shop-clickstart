...
<div class="container">
    ...
    <div class="span12">
        <div class="row">
            <form:form id="form" action="${pageContext.request.contextPath}/product/${id}" method="put">
                <div class="span7">
                    <div class="row">
                        <fieldset>
            ...
            <form:form action="${pageContext.request.contextPath}/product/${id}/photo" method="post"
